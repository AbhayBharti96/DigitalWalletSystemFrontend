...
import { walletService, rewardsService } from '../../core/api'
...
import type { TransferRequest, RazorpayOptions } from '../../types'
  ...
  return (
    <div className="p-4 lg:p-6 space-y-5 max-w-4xl mx-auto">
      ...
      <Modal open={modal === 'transfer'} onClose={() => setModal(null)} title="Transfer Money">
        <div className="space-y-4">
          {[
            { key: 'receiverId' as const, label: 'Receiver User ID', placeholder: 'Enter user ID', type: 'number' },
