...
const ScratchCanvas: React.FC<{
  ...
  useEffect(() => {
    ...
    ctx.fillText('Use your finger or mouse', width / 2, height / 2 + 16)
  }, [width, height, theme])
  ...
  const onMove = (e: React.MouseEvent | React.TouchEvent) => {
    const pos = getPos(e)
    if ('touches' in e && !isDrawing.current) return
    scratch(pos.x, pos.y)
  }
            ...
            <div className="px-5 pb-2">
              <div className="scratch-card-wrapper" style={{ width: cardW, maxWidth: '100%', height: cardH, margin: '0 auto' }}>
                ...
                >
                  ...
                  >
                    <div className="inline-flex mb-1"><Icon8 name="star" size={42} /></div>
                    <div className="font-display font-black text-4xl" style={{ color: theme.revealText }}>
                      +{points}
                    </div>
            ...
            <div className="px-6 pb-5 pt-2 text-center space-y-3">
              {!revealed ? (
                <p className="text-sm font-medium" style={{ color: theme.subtitle }}>
                  Scratch the card above to reveal your points
                </p>
              ) : !claimed ? (
                <motion.div
